export const locales = {
  ja: {
    ...
    'settings.templates.reset': '初期化',
    'settings.templates.resetConfirm': 'テンプレートを初期状態に戻しますか？カスタムテンプレートは削除されます。',
    ...
    'settings.skills.id': 'コマンド ID (英小文字・数字・ハイフン)',
    'settings.skills.idDuplicate': 'この ID は既に使用されています',
    'settings.skills.reset': '初期化',
    'settings.skills.resetConfirm': 'スキルを初期状態に戻しますか？カスタムスキルは削除されます。',
    ...
    'settings.notificationSound.title': '通知音',
    'settings.notificationSound.description': 'ツール実行の確認が必要な時に音を鳴らす',
  ...
  en: {
    ...
    'settings.templates.reset': 'Reset',
    'settings.templates.resetConfirm': 'Reset templates to defaults? Custom templates will be deleted.',
    ...
    'settings.skills.id': 'Command ID (lowercase, numbers, hyphens)',
    'settings.skills.idDuplicate': 'This ID is already in use',
    'settings.skills.reset': 'Reset',
    'settings.skills.resetConfirm': 'Reset skills to defaults? Custom skills will be deleted.',
    ...
    'settings.notificationSound.title': 'Notification Sound',
    'settings.notificationSound.description': 'Play a sound when tool execution needs approval',
